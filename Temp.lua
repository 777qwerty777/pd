...
function main() 
    ...
    tDialog = lua_thread.create_suspended(dialog) 
    sampRegisterChatCommand('asdf', function() tDialog:run() end) 
    load_base() 
    logins = { -- DEBUG 
        ['Gabriel_Montana1'] = {server = '185.169.134.11'}; 
        ['Gabriel_Montana2'] = {server = '185.169.134.34'}; 
        ['Gabriel_Montana3'] = {server = '185.169.134.22'}; 
        ['Gabriel_Montana4'] = {server = '185.169.134.20'};
    } 
    wait(-1) 
end 
